...
/// template parameter.
template <typename T>
class SmallVectorImpl : public SmallVectorTemplateBase<T, boost::is_POD<T>::value> {
  typedef SmallVectorTemplateBase<T, boost::is_POD<T>::value > SuperClass;
public:
  ...
  explicit SmallVectorImpl(unsigned N)
    : SmallVectorTemplateBase<T, boost::is_POD<T>::value>(N*sizeof(T)) {
  }
