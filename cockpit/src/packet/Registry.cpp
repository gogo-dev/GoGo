...
Registry::Registry()
	...
	MC_MATCH_LOGIN_GAMEON_JP(bind(do_nothing_5< const std::string&, const std::string&, boost::int32_t, boost::uint32_t, boost::tuple<Buffer /* data */, size_t /* count */, size_t /* size */> >, nothing_info(this, 1012), _1, _2, _3, _4, _5)),
	Match_ObjectCache(bind(do_nothing_2< boost::uint8_t, boost::tuple<Buffer /* data */, size_t /* count */, size_t /* size */> >, nothing_info(this, 1101), _1, _2)),
	...
	Channel_List(bind(do_nothing_1< boost::tuple<Buffer /* data */, size_t /* count */, size_t /* size */> >, nothing_info(this, 1213), _1)),
	...
	Match_Reset_TeamMembers(bind(do_nothing_1< boost::tuple<Buffer /* data */, size_t /* count */, size_t /* size */> >, nothing_info(this, 1552), _1)),
	...
	Match_Duel_QueueInfo(bind(do_nothing_1< boost::tuple<Buffer /* data */, size_t /* count */, size_t /* size */> >, nothing_info(this, 3100), _1)),
	...
	MC_QUEST_NPCLIST(bind(do_nothing_2< boost::tuple<Buffer /* data */, size_t /* count */, size_t /* size */>, boost::int32_t >, nothing_info(this, 6014), _1, _2)),
	...
	Quest_GameInfo(bind(do_nothing_1< boost::tuple<Buffer /* data */, size_t /* count */, size_t /* size */> >, nothing_info(this, 6051), _1)),
	...
	Quest_Complete(bind(do_nothing_1< boost::tuple<Buffer /* data */, size_t /* count */, size_t /* size */> >, nothing_info(this, 6054), _1)),
	...
	Quest_Peer_NPC_BasicInfo(bind(do_nothing_1< boost::tuple<Buffer /* data */, size_t /* count */, size_t /* size */> >, nothing_info(this, 6040), _1)),
	Quest_Peer_NPC_HPInfo(bind(do_nothing_2< boost::int32_t, boost::tuple<Buffer /* data */, size_t /* count */, size_t /* size */> >, nothing_info(this, 6041), _1, _2)),
	Quest_Peer_NPC_Attack_Melee(bind(do_nothing_1< boost::uint64_t >, nothing_info(this, 6042), _1)),
	Quest_Peer_NPC_Attack_Range(bind(do_nothing_2< boost::uint64_t, boost::tuple<Buffer /* data */, size_t /* count */, size_t /* size */> >, nothing_info(this, 6043), _1, _2)),
	...
	Quest_item_response(bind(do_nothing_1< boost::tuple<Buffer /* data */, size_t /* count */, size_t /* size */> >, nothing_info(this, 21001), _1)),
